			...
			extensions.push(
				Prec.highest(
					EditorView.theme({
						...
						".cm-searchMatch": {
							backgroundColor:
								"color-mix(in srgb, var(--interactive-accent) 35%, transparent) !important",
							outline:
								"1px solid color-mix(in srgb, var(--interactive-accent) 65%, transparent)",
							borderRadius: "2px",
						},
						".cm-searchMatch-selected, .cm-searchMatch.cm-searchMatch-selected": {
							backgroundColor:
								"color-mix(in srgb, var(--interactive-accent) 60%, transparent) !important",
